...
function onClickLinkedIn(){
    window.open("https://www.linkedin.com/in/sparsh-sharma-06012721b/", "_blank");
}
function onClickInsta(){
    window.open("https://www.instagram.com/sparsh3000/","_blank");
}
function onClickTwitter(){
    window.open("https://twitter.com/Sparsh3000","_blank");
}
